...
import apple from '../../assets/images/app-store.jpg'
import google from '../../assets/images/google-play.jpg'
    ...
    <div>
        ...
        <footer className="bg-green-50">
            <div className="w-full p-4 py-6 mx-auto max-w-screen-2xl lg:py-8">
                ...
                <div className="grid grid-cols-1 md:text-nowrap md:grid-cols-2 gap-8 md:gap-6 lg:grid-cols-6">
                    <div className="mb-6 md:mb-0">
                        <a href="#" className="flex items-center">
                        <img src={logo} classNameName="h-14" alt="Logo" />
                        </a>
                    </div>
