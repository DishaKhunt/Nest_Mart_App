  ...
  const Navigate = useNavigate("");
    ...
    const AddProductHandeler = ((e)=>{
        e.preventDefault();
            ...
            axios.put(`http://localhost:8000/products/${id}`,update).then(()=>{
                
                Swal.fire({
                title: "Thanks",
                text: "Thanks your product update successfully",
                icon: "success"
                });
            ...
            <div className="flex-1">
                ...
                <div>
                    ...
                    <form className="max-w-2xl mx-auto" onSubmit={AddProductHandeler}>
                        ...
                        <button type="submit" className="text-white bg-gradient-to-r mt-5 from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-bold rounded-lg text-base px-5 py-2.5 text-center me-2 mb-2"><i className="text-xl bi bi-cloud-plus me-3"></i> UPDATE PRODUCT</button>
