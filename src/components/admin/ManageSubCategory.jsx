    ...
    <div>
        <div className="flex">
            ...
            <div className="flex-1">
                <AdminHeader />
              <div className='p-10'>
                    <h1 className='mb-5 font-serif text-3xl font-bold text-center'>Mange Sub Category</h1>
                    ...
                    <div className="flex flex-wrap justify-center gap-5 mx-auto">
                        {data && data.map((item)=> (
                            ...
                            <a href="#">
                                <img className="w-full h-64 rounded-t-lg img-fluid" src={item.subCategoryPhoto} alt="product image" />
                            </a>
                            <div className="px-5 py-5">
                                
                                <a href="#">
                                    <h5 className="text-xl font-semibold tracking-tight text-gray-900 ">{item.subCategoryName}</h5>
                                </a>
